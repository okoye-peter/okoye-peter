...
Full Stack & Mobile Developer based in Lagos, Nigeria 🇳🇬. I build production-grade web and mobile applications end to end — from API design to pixel-perfect UI.

- 🌐 Building scalable web apps with React, Next.js & Node.js
- 📱 Shipping cross-platform mobile apps with **React Native** & **Flutter**
- 🤝 Open to full-time roles, remote contracts & open source collaboration
...
![REST API](https://img.shields.io/badge/REST-APIs-grey?style=flat)
